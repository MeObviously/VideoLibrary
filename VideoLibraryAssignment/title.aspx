<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="title.aspx.vb" Inherits="VideoLibraryAssignment.title" %>
...
<head runat="server">
    ...
    <title>Mrs McCree's Video Library</title>

    <!-- Links for css, bootstrap -->
    <link href="css/boostrap.min.css" rel="stylesheet" type="text/css" />	<!-- edit the file name -->
...
<body/>
    ...
    <div class="navbar navbar-default" role="navigation">
	    <div class="navbar-header">
		    ...
		    <h1>Mrs McCree's Video Library</h1>
